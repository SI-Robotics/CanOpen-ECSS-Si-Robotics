...
static struct {
	...
	.sub0 = 0x02,
	.sub1 = CO_ARRAY_C,
	.sub2 = CO_VISIBLE_STRING_C("./co-nmt-slave.dcf"),
};

static co_obj_t od_master_1F20 = {
	.node = { .key = &od_master_1F20.idx },
	.idx = 0x1F20,
	.code = CO_OBJECT_ARRAY,
#if !LELY_NO_CO_OBJ_NAME
	.name = CO_DEV_STRING("Store DCF"),
#endif
	.tree = { .cmp = &uint8_cmp },
	.val = &od_master_1F20_val,
	.size = sizeof(od_master_1F20_val)
};

static co_sub_t od_master_1F20sub0 = {
	.node = { .key = &od_master_1F20sub0.subidx },
	.subidx = 0x00,
	.type = CO_DEFTYPE_UNSIGNED8,
#if !LELY_NO_CO_OBJ_NAME
	.name = CO_DEV_STRING("Highest sub-index supported"),
...
static co_sub_t od_master_1F20sub1 = {
	.node = { .key = &od_master_1F20sub1.subidx },
	.subidx = 0x01,
	.type = CO_DEFTYPE_DOMAIN,
#if !LELY_NO_CO_OBJ_NAME
	.name = CO_DEV_STRING("Node-ID 1"),
#endif
#if !LELY_NO_CO_OBJ_LIMITS
...
static co_sub_t od_master_1F20sub2 = {
	.node = { .key = &od_master_1F20sub2.subidx },
	.subidx = 0x02,
	.type = CO_DEFTYPE_DOMAIN,
#if !LELY_NO_CO_OBJ_NAME
	.name = CO_DEV_STRING("Node-ID 2"),
#endif
#if !LELY_NO_CO_OBJ_LIMITS
	.min = { .dom = CO_DOMAIN_MIN },
	.max = { .dom = CO_DOMAIN_MAX },
	...
	.def = { .dom = NULL },
#endif
	.val = &od_master_1F20_val.sub2,
	.access = CO_ACCESS_RO,
	.pdo_mapping = 0,
	.flags = 0 | CO_OBJ_FLAGS_UPLOAD_FILE,
	.dn_ind = &co_sub_default_dn_ind,
#if !LELY_NO_CO_OBJ_UPLOAD
	.up_ind = &co_sub_default_up_ind
#endif
...
static struct {
	...
	.sub0 = 0x02,
	.sub1 = CO_ARRAY_C,
	.sub2 = CO_VISIBLE_STRING_C("./co-nmt-master.dat"),
};

static co_obj_t od_master_1F58 = {
	.node = { .key = &od_master_1F58.idx },
	.idx = 0x1F58,
	.code = CO_OBJECT_ARRAY,
#if !LELY_NO_CO_OBJ_NAME
...
#endif
	.tree = { .cmp = &uint8_cmp },
	.val = &od_master_1F58_val,
	.size = sizeof(od_master_1F58_val)
};

static co_sub_t od_master_1F58sub0 = {
	.node = { .key = &od_master_1F58sub0.subidx },
	.subidx = 0x00,
	.type = CO_DEFTYPE_UNSIGNED8,
#if !LELY_NO_CO_OBJ_NAME
	.name = CO_DEV_STRING("Highest sub-index supported"),
...
static co_sub_t od_master_1F58sub1 = {
	.node = { .key = &od_master_1F58sub1.subidx },
	.subidx = 0x01,
	.type = CO_DEFTYPE_DOMAIN,
#if !LELY_NO_CO_OBJ_NAME
	.name = CO_DEV_STRING("Node-ID 1"),
...
static co_sub_t od_master_1F58sub2 = {
	.node = { .key = &od_master_1F58sub2.subidx },
	.subidx = 0x02,
	.type = CO_DEFTYPE_DOMAIN,
#if !LELY_NO_CO_OBJ_NAME
	.name = CO_DEV_STRING("Node-ID 2"),
...
od_master_init(void) {
	...
	if (!dev) {
		...
		co_dev_insert_obj(&od_master, &od_master_1F20);
		co_obj_insert_sub(&od_master_1F20, &od_master_1F20sub0);
		co_obj_insert_sub(&od_master_1F20, &od_master_1F20sub1);
		co_obj_insert_sub(&od_master_1F20, &od_master_1F20sub2);
		...
		co_dev_insert_obj(&od_master, &od_master_1F58);
		co_obj_insert_sub(&od_master_1F58, &od_master_1F58sub0);
		co_obj_insert_sub(&od_master_1F58, &od_master_1F58sub1);
		co_obj_insert_sub(&od_master_1F58, &od_master_1F58sub2);
